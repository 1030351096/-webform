<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gerenzhongxin1.aspx.cs" Inherits="xgf_gerenzhongxin1" %>
...
<head runat="server">
    ...
    <link href="css/gerenzhongxin1.css" rel="stylesheet" />
    <script src="DatePicker/WdatePicker.js"></script>
    <title>食趣自营嗨购  资料修改</title>
</head>
<body>
        ...
        <div class="container-fluid" style="width: 70%;">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    ...
                    <div class="gerenzhongxin grzx12" style="color:#ff0000;">个人信息</div>
                    <a href="gerenzhongxin2.aspx">
                    <div class="gerenzhongxin grzx13">安全设置</div></a>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="height: 800px;">
                    <div class="gerenxinxi">
                        <div class="gerenxinxi1">个人资料</div>
                        <div class="gerenxinxi2">/ Personal information</div>
                        <div style="width: 100%; height: 1px; border-bottom: 1px solid #808080; clear: both;"></div>

                        <div class="gerenxinxi_ziliao">
                            <%--个人信息资料头像--%>
                            <div class="gerenxinxi_ziliao_touxiang">
                                <img src="images/touxiang.jpg" />
                            </div>
                            <%--个人信息资料信息--%>
                            <div class="gerenxinxi_ziliao_xinxi">
                                <div class="gerenxinxi_ziliao_xinxi_1">用户名：<span id="username" runat="server">小叮当</span></div>
                                <div class="gerenxinxi_ziliao_xinxi_1">铜牌会员</div>
                                <div class="gerenxinxi_ziliao_xinxi_1">账户安全&nbsp;60&nbsp;分</div>
                            </div>
                        ...
                        <%--个人信息修改--%>
                        <div class="gerenxinxi_xiugai">
                            <div class="gerenxinxi_xiugai_meiyihang">
                                <div class="gerenxinxi_xiugai_meiyihang_1" style="float:left">昵称</div>
                                <input type="text" id="nicheng" style="float:left;width:500px;height:40px;margin-top:10px;" class="form-control" placeholder="昵称" runat="server" />
                            </div>
                            <div class="gerenxinxi_xiugai_meiyihang">
                                <div class="gerenxinxi_xiugai_meiyihang_1" style="float:left">姓名</div>
                                <input type="text" id="xingming" style="float:left;width:500px;height:40px;margin-top:10px;" class="form-control" placeholder="姓名" runat="server" />
                            </div>
                            <div class="gerenxinxi_xiugai_meiyihang">
                                <div class="gerenxinxi_xiugai_meiyihang_1" style="float:left">性别</div>
                                <div style="height:20px;"></div>
                                <asp:RadioButtonList ID="xingbie" runat="server" RepeatDirection="Horizontal">
                                    <asp:ListItem Text="男" Selected="True" Value="true"></asp:ListItem>
                                    <asp:ListItem Text="女" Value="false"></asp:ListItem>
                                </asp:RadioButtonList>
                            </div>
                            <div class="gerenxinxi_xiugai_meiyihang">
                                <div class="gerenxinxi_xiugai_meiyihang_1" style="float:left">生日</div>
                                <input type="text" id="shengri" style="float:left;width:500px;height:40px;margin-top:10px;" class="form-control" placeholder="生日" runat="server" />
                            </div>
                            
                            <div class="gerenxinxi_xiugai_meiyihang">
                                <div class="gerenxinxi_xiugai_meiyihang_1" style="float:left">邮箱</div>
                                <input type="text" id="youxiang" style="float:left;width:500px;height:40px;margin-top:10px;" class="form-control" placeholder="邮箱" runat="server" />
                            </div>
                            <div class="gerenxinxi_xiugai_meiyihang">
                                <asp:Button ID="baocunxiugai" runat="server" Text="保存修改" style="background-color:#ff0000;color:#ffffff;margin-left:40%;margin-top:20px;width:100px;height:30px;" />
                            </div>
...
<script type="text/javascript">
    ...
    $("#baocunxiugai").click(function () {
        ...
        {
            $("#youxiang").css("border", "1px solid #ff0000");
            return false;
        }
    });
