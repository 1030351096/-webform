<%@ Page Language="C#" AutoEventWireup="true" CodeFile="password.aspx.cs" Inherits="xgf_password" %>
            ...
            <div class="container-fluid" style="width: 70%;">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        ...
                        <div class="gerenzhongxin grzx13" style="color:#ff0000;">安全设置</div></a>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="height: 800px;">
                        ...
                        <div class="anquanshezhi">
                            <div class="anquanshezhi1">修改密码</div>
                            <div class="anquanshezhi2">/ Password</div>
                        ...
                        <div class="xiugaikuang">
                            ...
                            <div class="xiugaikuang_meiyihang">
                                <div class="xiugaikuang_meiyihang_1">原始密码</div>
                                <div class="xiugaikuang_meiyihang_2">
                                    <asp:TextBox ID="yuanshimima" CssClass="wenbenkuang form-control" runat="server" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>


                            <div class="xiugaikuang_meiyihang">
                                <div class="xiugaikuang_meiyihang_1">新密码</div>
                                <div class="xiugaikuang_meiyihang_2">
                                    <asp:TextBox ID="xinmima" CssClass="wenbenkuang form-control" runat="server" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="xiugaikuang_meiyihang">
                                <div class="xiugaikuang_meiyihang_1">确认密码</div>
                                <div class="xiugaikuang_meiyihang_2">
                                    <asp:TextBox ID="querenmima" CssClass="wenbenkuang form-control" runat="server" TextMode="Password"></asp:TextBox>
                                </div>
                            </div>

                            <asp:Button ID="xiugaimima" runat="server" Text="保存修改" />
...
<script type="text/javascript">
    $("#xiugaimima").click(function () {
        $(".wenbenkuang").focus(function () {
            $(".wenbenkuang").css("border", "1px solid #aaaaaa");
        });
        if ($("#yuanshimima").val() == "") {
            $("#yuanshimima").css("border", "2px solid #ff0000");
            return false;
        }
        if ($("#xinmima").val() == "") {
            $("#xinmima").css("border", "2px solid #ff0000");
            return false;
        }
        if ($("#querenmima").val() == "") {
            $("#querenmima").css("border", "2px solid #ff0000");
            return false;
        }
