<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gerenzhongxin2.aspx.cs" Inherits="xgf_gerenzhongxin2" %>
...
<head runat="server">
    ...
    <link href="css/gerenzhongxin2.css" rel="stylesheet" />
    <title>食趣自营嗨购  安全设置</title>
</head>
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                        ...
                        <a href="gerenzhongxin.aspx">
                            <div class="gerenzhongxin grzx">个人中心</div>
                        </a>

                        <div style="height: 20px;"></div>
                        <a href="gerenzhongxin.aspx">
                        <div class="gerenzhongxin grzx11" style="font-weight: 600;">个人资料</div></a>
                        <a href="gerenzhongxin1.aspx">
                        <div class="gerenzhongxin grzx12">个人信息</div></a>
                        <div class="gerenzhongxin grzx13" style="color:#ff0000;">安全设置</div>
                    ...
                    <%--个人--%>
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12" style="height: 900px;">
                        <div class="anquanshezhi">
                            <div class="anquanshezhi1">账户安全</div>
                            <div class="anquanshezhi2">/ Set up Safety</div>
                            <div style="width: 100%; height: 1px; border-bottom: 1px solid #808080; clear: both;"></div>

                            <div class="anquanshezhi_ziliao">
                                <%--个人信息资料头像--%>
                                <div class="anquanshezhi_ziliao_touxiang">
                                    <img src="images/touxiang.jpg" />
                                </div>
                                <%--个人信息资料信息--%>
                                <div class="anquanshezhi_ziliao_xinxi">
                                    <div class="anquanshezhi_ziliao_xinxi_1">用户名：<span id="username" runat="server">小叮当</span></div>
                                    <div class="anquanshezhi_ziliao_xinxi_1">铜牌会员</div>
                                    <div class="anquanshezhi_ziliao_xinxi_1">账户安全&nbsp;60&nbsp;分</div>
                                </div>

                            </div>
                            <div style="width: 100%; height: 1px; border-bottom: 1px solid #eeeeee; clear: both; margin-top: 20px; margin-bottom: 20px;"></div>


                            <div class="anquanshezhi_div">
                                <%--安全设置div每一行--%>
                                <div class="anquanshezhi_div_meiyihang">
                                    <%--安全设置div每一行图标--%>
                                    <div class="anquanshezhi_div_meiyihang_1" style="background-image: url(images/anquanxiaotubiao.png); background-position: -90px -45px;"></div>
                                    <%--安全设置div每一行文字--%>
                                    <div class="anquanshezhi_div_meiyihang_2">
                                        <div class="anquanshezhi_div_meiyihang_21">登录密码</div>
                                        <div class="anquanshezhi_div_meiyihang_22">为保证您购物安全，建议您定期更改密码以保护账户安全。</div>
                                    </div>
                                    <%--安全设置div每一行按钮--%>
                                    <input type="button" class="anquanshezhi_div_meiyihang_3 anquanshezhi_div_meiyihang_31" value="修改" onclick="location.href='password.aspx'" />
                                </div>
                                <div class="anquanshezhi_div_meiyihang">
                                    <%--安全设置div每一行图标--%>
                                    <div class="anquanshezhi_div_meiyihang_1" style="background-image: url(images/anquanxiaotubiao.png); background-position: -0px -135px;"></div>
                                    <%--安全设置div每一行文字--%>
                                    <div class="anquanshezhi_div_meiyihang_2">
                                        <div class="anquanshezhi_div_meiyihang_21">支付密码</div>
                                        <div class="anquanshezhi_div_meiyihang_22">启用支付密码功能，为您资产账户安全加把锁。</div>
                                    </div>
                                    <%--安全设置div每一行按钮--%>
                                    <input type="button" class="anquanshezhi_div_meiyihang_3 anquanshezhi_div_meiyihang_32" value="立即启用" />
                                </div>
                                <div class="anquanshezhi_div_meiyihang">
                                    <%--安全设置div每一行图标--%>
                                    <div class="anquanshezhi_div_meiyihang_1" style="background-image: url(images/anquanxiaotubiao.png); background-position: -45px -0px;"></div>
                                    <%--安全设置div每一行文字--%>
                                    <div class="anquanshezhi_div_meiyihang_2">
                                        <div class="anquanshezhi_div_meiyihang_21">手机认证</div>
                                        <div class="anquanshezhi_div_meiyihang_22">您验证的手机：186XXXXXXXX 若已丢失或停用，请立即更换</div>
                                    </div>
                                    <%--安全设置div每一行按钮--%>
                                    <input type="button" class="anquanshezhi_div_meiyihang_3 anquanshezhi_div_meiyihang_33" value="换绑" />
                                </div>
                                <div class="anquanshezhi_div_meiyihang">
                                    <%--安全设置div每一行图标--%>
                                    <div class="anquanshezhi_div_meiyihang_1" style="background-image: url(images/anquanxiaotubiao.png); background-position: -0px -90px;"></div>
                                    <%--安全设置div每一行文字--%>
                                    <div class="anquanshezhi_div_meiyihang_2">
                                        <div class="anquanshezhi_div_meiyihang_21">邮箱验证</div>
                                        <div class="anquanshezhi_div_meiyihang_22">您验证的邮箱：5831XXX@qq.com 可用于快速找回登录密码</div>
                                    </div>
                                    <%--安全设置div每一行按钮--%>
                                    <input type="button" class="anquanshezhi_div_meiyihang_3 anquanshezhi_div_meiyihang_34" value="换绑" />
                                </div>
                                <div class="anquanshezhi_div_meiyihang">
                                    <%--安全设置div每一行图标--%>
                                    <div class="anquanshezhi_div_meiyihang_1" style="background-image: url(images/anquanxiaotubiao.png); background-position: -90px -90px;"></div>
                                    <%--安全设置div每一行文字--%>
                                    <div class="anquanshezhi_div_meiyihang_2">
                                        <div class="anquanshezhi_div_meiyihang_21">实名认证</div>
                                        <div class="anquanshezhi_div_meiyihang_22">用于提升账号的安全性和信任级别，认证后不能修改认证信息。</div>
                                    </div>
                                    <%--安全设置div每一行按钮--%>
                                    <input type="button" class="anquanshezhi_div_meiyihang_3 anquanshezhi_div_meiyihang_35" value="认证" />
                                </div>
                                <div class="anquanshezhi_div_meiyihang">
                                    <%--安全设置div每一行图标--%>
                                    <div class="anquanshezhi_div_meiyihang_1" style="background-image: url(images/anquanxiaotubiao.png); background-position: -135px -45px;"></div>
                                    <%--安全设置div每一行文字--%>
                                    <div class="anquanshezhi_div_meiyihang_2">
                                        <div class="anquanshezhi_div_meiyihang_21">安全问题</div>
                                        <div class="anquanshezhi_div_meiyihang_22">保护账户安全，验证您身份的工具之一。</div>
                                    </div>
                                    <%--安全设置div每一行按钮--%>
                                    <input type="button" class="anquanshezhi_div_meiyihang_3 anquanshezhi_div_meiyihang_36" value="认证" />
                                </div>
