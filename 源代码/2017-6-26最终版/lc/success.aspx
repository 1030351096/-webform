<%@ Page Language="C#" AutoEventWireup="true" CodeFile="success.aspx.cs" Inherits="lc_success" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="css/sustyle.css" rel="stylesheet" />
    <link href="../xgf/css/index.css" rel="stylesheet" />
</head>
<body>
...
<div class="take-delivery">
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
       <li>付款金额<em id="ms" runat="server">¥9.90</em></li>
       <div class="user-info">
         <p id="shr" runat="server">收货人：艾迪</p>
         <p id="dianhua" runat="server">联系电话：15871145629</p>
